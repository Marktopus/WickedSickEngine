...
{
  MATHDLL_API Matrix3::Matrix3(void) : m00(0.0f), m01(0.0f), m02(0.0f),
                           m10(0.0f), m11(0.0f), m12(0.0f),
                           m20(0.0f), m21(0.0f), m22(0.0f)
  {
  }

  MATHDLL_API Matrix3::Matrix3(const Matrix3& rhs) : m00(rhs.m00), m01(rhs.m01), m02(rhs.m02),
                                         m10(rhs.m10), m11(rhs.m11), m12(rhs.m12),
                                         m20(rhs.m20), m21(rhs.m21), m22(rhs.m22)
  {
  }

  MATHDLL_API Matrix3::Matrix3(float mm00, float mm01, float mm02,
                   float mm10, float mm11, float mm12,
                   float mm20, float mm21, float mm22) : m00(mm00), m01(mm01), m02(mm02), 
  ...
  //assignment
  MATHDLL_API Matrix3& Matrix3::operator=(const Matrix3& rhs)
  {
    if(this != &rhs)
    {
  ...
  MATHDLL_API void Matrix3::Transpose()
  {
    std::swap(m10, m01); std::swap(m20, m02);
                         std::swap(m21, m12);
  }

  MATHDLL_API void Matrix3::Inverse()
  {
    Identity();
  }

  //multiplication by vector / point
  MATHDLL_API Vector3 Matrix3::operator*(const Vector3& rhs) const
  {
  ...
  //addition
  MATHDLL_API Matrix3 Matrix3::operator+(const Matrix3& rhs) const
  {
  ...
  //scaling
  MATHDLL_API Matrix3 Matrix3::operator*(const float rhs) const
  {
  ...
  //scale assignment
  MATHDLL_API Matrix3& Matrix3::operator*=(const float rhs)
  {
  ...
  //equality
  MATHDLL_API bool Matrix3::operator==(const Matrix3& rhs) const
  {
  ...
  MATHDLL_API void Matrix3::Zero(void)
  {
    m00 = m01 = m02 = 
    m10 = m11 = m12 = 
    m20 = m21 = m22 = 0.0f;
  ...
  MATHDLL_API void Matrix3::Identity(void)
  {
          m01 = m02 = 
    m10 =       m12 =
    m20 = m21       = 0.0f;
  ...
  MATHDLL_API void Matrix3::Print(void) const
  {
    //ConsolePrint("--------------------------");
