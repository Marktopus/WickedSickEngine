...
{
  MATHDLL_API Matrix4::Matrix4(void) : m00(0.0f), m01(0.0f), m02(0.0f), m03(0.0f),
  ...
  MATHDLL_API Matrix4::Matrix4(const Matrix4& rhs) : m00(rhs.m00), m01(rhs.m01), m02(rhs.m02), m03(rhs.m03),
  ...
  MATHDLL_API Matrix4::Matrix4(const float* f) 
  {
    *this = *(const Matrix4*)f;
  }

  MATHDLL_API Matrix4::Matrix4(float mm00, float mm01, float mm02, float mm03,
  ...
  //assignment
  MATHDLL_API Matrix4& Matrix4::operator=(const Matrix4& rhs)
  {
    if(this != &rhs)
    {
  ...
  MATHDLL_API void Matrix4::Inverse()
  {
  ...
  MATHDLL_API Vector4 Matrix4::operator*(const Vector4& rhs) const
  {
  ...
  //addition
  MATHDLL_API Matrix4 Matrix4::operator+(const Matrix4& rhs) const
  {
  ...
  //scaling
  MATHDLL_API Matrix4 Matrix4::operator*(const float rhs) const
  {
  ...
  //scale assignment
  MATHDLL_API Matrix4& Matrix4::operator*=(const float rhs)
  {
  ...
  //equality
  MATHDLL_API bool Matrix4::operator==(const Matrix4& rhs) const
  {
  ...
  MATHDLL_API Matrix4& Matrix4::DoOrthographic(int width, int height, float znear, float zfar)
  {
    Zero();
