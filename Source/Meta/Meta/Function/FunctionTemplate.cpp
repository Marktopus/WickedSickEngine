...
Function::ReturnType<RetType>::ReturnType()
{
}

template <typename RetType>
Function::ReturnType<RetType>::ReturnType(RetTypeFinal&& in)
{
...
template <typename RetType>
Function::ReturnType<RetType>::ReturnType(const RetTypeFinal& in)
{
  memcpy((void*)object, (void*)&in, sizeof(in));
}

template <typename RetType>
void Function::ReturnType<RetType>::Set(RetTypeFinal&& in)
{
  memcpy((void*)object, (void*)&in, sizeof(in));
}

template <typename RetType>
void Function::ReturnType<RetType>::Set(const RetTypeFinal& in)
{
  memcpy((void*)object, (void*)&in, sizeof(in));
}

template <typename RetType>
void* Function::ReturnType<RetType>::Get() const
{
  return (void*)object;
}
