...
namespace WickedSick
{
  ...
  PHYSICSDLL_API PhysicsScene::PhysicsScene() : dynamic_broadphase_(nullptr),
                                 static_broadphase_(nullptr),
                                 scene_loaded_(false)
  {
  }

  PHYSICSDLL_API PhysicsScene::~PhysicsScene()
  {
  }

  PHYSICSDLL_API void PhysicsScene::Initialize()
  {

  }

  PHYSICSDLL_API void PhysicsScene::Update(float dt)
  {
    if(scene_loaded_)
    {
      Integrate(dt);
  ...
  PHYSICSDLL_API void PhysicsScene::Integrate(float dt)
  {
  ...
  PHYSICSDLL_API void PhysicsScene::CheckCollisions()
  {
    Vector3 Position1;
    Vector3 Position2;
    RigidBody* first;
  ...
  PHYSICSDLL_API void PhysicsScene::ResolveCollisions(float dt)
  {
    for(int i = 0; i < 10; ++i)
    {
  ...
  PHYSICSDLL_API void PhysicsScene::UnloadScene()
  {
    scene_loaded_ = false;
    rigid_bodies_.clear();
    colliders_.clear();
  ...
  PHYSICSDLL_API void PhysicsScene::LoadScene()
  {
  ...
  PHYSICSDLL_API void PhysicsScene::SetLoaded(bool loaded) 
  { 
    scene_loaded_ = loaded; 
  }

  PHYSICSDLL_API void PhysicsScene::AddPhysicsObject(PhysicsComponent* comp)
  {
  ...
  PHYSICSDLL_API void PhysicsScene::Refresh()
  {

  }

  PHYSICSDLL_API void PhysicsScene::AddCollider(Collider* coll)
  {
    colliders_.push_back(coll);
  }

  PHYSICSDLL_API std::vector<RigidBody*>& PhysicsScene::GetRigidBodies() 
  { 
    return rigid_bodies_; 
  }

  PHYSICSDLL_API BroadPhase * PhysicsScene::GetDynamicBroadphase() 
  { 
    return dynamic_broadphase_; 
  }

  PHYSICSDLL_API BroadPhase * PhysicsScene::GetStaticBroadphase() 
  { 
    return static_broadphase_; 
  }

  PHYSICSDLL_API bool PhysicsScene::GetIteration() 
  { 
