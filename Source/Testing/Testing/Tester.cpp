...
{
  TESTINGDLL_API Tester::Tester() :  mem_check_(false),
                      time_check_(false),
                      silent_(false)
  {
  ...
  TESTINGDLL_API void Tester::AddTest(UnitTest* newTest)
  {
    tests_.push_back(newTest);
  }

  TESTINGDLL_API void Tester::AddTest(testerFn test,
  ...
  TESTINGDLL_API bool Tester::RunTest(int testNumber)
  {
    TestInfo info;
  ...
  TESTINGDLL_API bool Tester::RunTestCategory(const std::string& category)
  {
  ...
  TESTINGDLL_API bool Tester::RunAllTests()
  {
